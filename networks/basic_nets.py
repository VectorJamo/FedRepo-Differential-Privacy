...
class ClassifyNet(nn.Module):
    def __init__(self, net, init_way, n_classes, input_size=None):
        ...
        model = get_basic_net(net, n_classes, input_size=input_size)
...
class MLPNet(nn.Module):
    def __init__(self, input_size, input_channel=1, n_classes=10):
        super().__init__()
        #self.input_size = input_channel * input_size ** 2
        #self.input_size =input_size
        self.input_size = input_size #DAC
        #self.input_size = 33 #Swipe
        #self.input_size = 104 #Voice
        self.n_classes = n_classes
...
class TFCNN(nn.Module):
    def __init__(self, n_classes):
        ...
        self.encoder = nn.Sequential(
            nn.Conv2d(3, 32, 3, stride=1, padding=1), # IMPORTANT: FOR TRAIN_FACE_LAB, CHANGE THE INPUT N_CHANNELS TO 1 
            nn.ReLU(True),
            nn.MaxPool2d(2),
...
# Step 8: Define the PyTorch model
class SequentialModel(nn.Module):
    def __init__(self, input_dim, output_dim):
        ...
        self.model = nn.Sequential(
            ...
            nn.Sigmoid() if output_dim == 1 else nn.Softmax(dim=1)  # Sigmoid for binary, Softmax for multi-class
        )
